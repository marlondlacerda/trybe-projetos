...
<div align="center">
  ...
  <div align="left" style="display: inline_block">
    ...
    <span>
      Este Repositório possuí projeto desenvolvido no período que estive na Trybe, abordando sobre conceitos de javascript, escrever funções a partir dos requisitos pedidos.
    </span><br>
...
- Foi implementado funções a partir de requisitos;
- Criação de funções seguindo os requisitos especificados para o correto comportamento de cada uma delas.
---
...
1. Clone o repositório
  ...
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd trybe-projetos/fundamentals/bloco_4/playground-functions`
